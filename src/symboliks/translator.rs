...
impl SymbolikTranslator {
    ...
    fn i_test(&mut self, op: &Opcode) {
        ...
        let pf = SymbolicValue::oper(Op::Xor,
            SymbolicValue::oper(Op::Xor, v1, v2),
            neg_one);
