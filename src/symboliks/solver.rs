...
mod tests {
    ...
    fn test_var_plus_offset() {
        ...
        let c = SymbolicValue::constraint(ConstraintOp::Ult, expr, SymbolicValue::constant(15, 4));
    ...
    fn test_verify_with_arithmetic() {
        ...
        let c = SymbolicValue::constraint(ConstraintOp::Eq, expr, SymbolicValue::constant(10, 4));
    ...
    fn test_var_minus_offset() {
        ...
        let c = SymbolicValue::constraint(ConstraintOp::Ult, expr, SymbolicValue::constant(5, 4));
        let range = solver.find_range("x", 4, &[c]);
    ...
    fn test_ne_constraint_cannot_extract_bounds() {
        ...
        assert!(solver.check_sat(std::slice::from_ref(&c)));
