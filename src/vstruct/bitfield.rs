...
impl BitField {
    ...
    pub fn define_field(&mut self, name: &str, bit_offset: usize, bit_width: usize) -> VivResult<()> {
        ...
        self.fields.insert(name.to_string(), (bit_offset, bit_width));
        Ok(())
    }
    ...
    pub fn parse(&mut self, bytes: &[u8], offset: usize) -> VivResult<usize> {
        ...
        self.value = match (self.endian, self.size) {
            ...
            (Endian::Little, 4) => u32::from_le_bytes([slice[0], slice[1], slice[2], slice[3]]) as u64,
