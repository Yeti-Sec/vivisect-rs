...
- **Disassembly** — x86/x64 via [iced-x86](https://github.com/icedland/iced), ARM/AArch64/MIPS via [capstone](https://github.com/capstone-engine/capstone)
- **Code Flow Analysis** — Function discovery, basic block construction, CFG/call graph generation
...
- **CPU Emulation** — Full x86/ARM emulation via [icicle-emu](https://github.com/icicle-emu/icicle-emu) with [Ghidra](https://github.com/NationalSecurityAgency/ghidra) SLEIGH processor specs
...
│   └── archs/      x86 (iced-x86), ARM, AArch64, MIPS (capstone)
...
workspace.analyze()                 27-module orchestrated pipeline
    ...
    ├── String detection             ASCII, UTF-16LE inline strings
